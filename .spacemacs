;; -*- mode: emacs-lisp -*- ;; This file is loaded by Spacemacs at startup.  ;; It must be stored in your home directory.  
...
you should place your code here."
  (display-time-mode 1)
  (defun configure-nyancat ()
    (if (derived-mode-p 'term-mode)
        (nyan-mode 0)
      (progn (nyan-mode 1) (nyan-start-animation))
      ))
  (add-hook 'focus-in-hook 'configure-nyancat)
